...
for block_num, block in trials.groupby("block"):
    ...
    for real_trial_num, (trial_num, trial) in enumerate(block.groupby("trial")):
        ...
        for idx in trial.index:
            ...
            for motor in sponge.motors:
                if motor in pattern["motors"]:
                    ...
                    # intensity = 250 if (intensity > 250) else intensity
                    # intensity = 250 if (intensity == 127) else intensity
                    print(intensity)
